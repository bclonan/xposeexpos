          ...
          <div class="section-wrapper">
            ...
            <div class="columns dashboard-columns">
              ...
              <div class="column is-11">
                <h2 class="project-title">Widget Manager</h2>
                <div class="navigation-tabs layout-tabs animated-tabs mt-20 mb-20">
                  <div class="tabs is-toggle is-fullwidth">
                    <ul>
                      <li class="tab-link" @click.stop="setActiveTab('soloTab')" :class="{ 'is-active': isTabActive('soloTab') }">
                        <a>Solo</a>
                      </li>
                      <li class="tab-link" @click.stop="setActiveTab('collaborative')" :class="{ 'is-active': isTabActive('collaborative') }">
                        <a>Purchased/download/incomplete</a>
                      </li>
                    </ul>
                  </div>
                  <div class="navtab-content" :class="{ 'is-active': isTabActive('soloTab') }">
                    <div class="projects-list-wrapper">
                      ...
                      <div class="list-body">
                        ...
                        />-->
                          <project-Card v-for="item in projectData" :item="item" :key="item.id" :dropDownActiveItem="dropDownActiveItem" @toggleDropdown="toggleDropdown" @editProject="editThisProject" @projectStats="pullProjectStats" @deleteProject="deleteThisProject" />
                        </div>
                      </div>
                    </div>
                  </div>
