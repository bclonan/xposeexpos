<template>
<!-- Edit sub view -->
<div id="edit-view" class="column is-10 is-offset-1">
    <div class="flex-card is-top light-bordered raised animated preFadeInUp fadeInUp">
        <div class="edit-button has-text-centered">
            ...
            <div class="cross-container edit-trigger"  @click="toggleEditProfile('ProfileDetailsView')">
                <span class="top"></span>
