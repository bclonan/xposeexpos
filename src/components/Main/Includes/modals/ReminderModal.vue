<template>
    <!-- Reminder Modal -->
    <div class="modal modal-sm modal-hero" v-if="activeModalOverlayToggled === 'createReminderModal'" :class="[ activeModalOverlayToggled === 'createReminderModal' ? 'is-active' : '']">
        ...
        <button class="modal-close" @click="resetActiveModalOverlay" :class="[ activeModalOverlayToggled === 'createReminderModal' ? 'is-large' : 'is-hidden']" aria-label="close"></button>
    </div>
    <!-- Reminder Modal -->
</template>
