...
<footer class="footer">
    <div class="container">
        <div class="footer-flex">
            <div class="nephos">
                <img class="logo" src="assets/images/logo/nephos-white.svg">
                <span class="logo-text">Nephos</span>
            </div>
            <div class="ninja">
                <div class="made-by">&copy; 2018 | Designed and coded with <i data-feather="heart" class="love"></i> by</div>
